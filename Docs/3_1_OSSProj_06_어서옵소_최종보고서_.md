...
- 방식
  ...
  - 수강생 화면
  <img src="https://github.com/CSID-DGU/2024-1-OSSProj-WelcomeOPSO-06/assets/144206885/d6e0fa0f-8a03-46d3-ae3d-850b15be55e5">
...
#### 3. 선행 기술 비교표
<img src="https://github.com/CSID-DGU/2024-1-OSSProj-WelcomeOPSO-06/assets/144206885/a9798f1d-010c-4224-a188-ca98d37ef0e5">
...
| 5 <td rowspan="2">모임 상세 페이지(주최자)</td>                  | 출석 확인      | QR코드 생성으로 출석, 지각, 결석 처리 기능<br>출석, 지각의 제한 시간 설정 기능 <br> 플로팅 기능, 재생성 기능 |
...
- 최종 결과물은 QR Login 오픈소스를 활용하여, 숫자 코드 출석의 단점을 보완하고 사용자의 편의성을 높이는 QR 출석을 구현하는 것이다.
- 최종 설계 결과물의 형태는 웹사이트 형태로 주최자는 화면이 연결되어 있는 컴퓨터로 접근하고, 참여자들은 모바일 기기로 쉽게 접근하여 참여자들의 출석을 완료하고 관리하는 웹사이트가 될 예정이다.
- 우리의 서비스는 간략하게 2가지 기능이 존재한다. 주최자가 사용해야 할 기능과 참여자들이 사용해야 할 기능을 나누어 개발하고자 한다.
  - 주최자의 기능은 출석 QR코드를 생성하고, 출석 마감 시간을 설정하는 기능, 그리고 출석 시간이 끝나고 참여자들의 출석을 관리하는 기능으로 구현하고자 한다. 이때 QR코드를 플로팅하여 모임을 진행하면서 출석을 진행할 수 있도록 구현한다.
  - 참여자의 기능으로는 QR코드를 인식하여 로그인을 하고 모임 관리 페이지에 들어가 QR을 스캔하여 출석을 완료할 수 있도록 구현한다.
- 동국대 공식 홈페이지인 동국대학교 이클래스와 연결은 동국대의 보안적인 이유로 연결하기 어렵다고 판단하여 우리의 프로젝트는 모임에 대한 QR출석에 대한 기능을 구현하고자 한다.
...
- DB 구성
![KakaoTalk_20240609_225259929](https://github.com/CSID-DGU/2024-1-OSSProj-WelcomeOPSO-06/assets/144206885/aeccbce3-1932-40ea-bc4f-9cfb6a98f6e8)
